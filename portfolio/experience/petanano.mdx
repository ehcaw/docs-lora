...
description: Ryan's experience as a Software Engineering Intern at Petanano, developing optimization algorithms for robotic arms using gradient descent and inverse kinematics.
---
...
This internship was a pivotal experience that expanded my understanding of software's role in the physical world. The 50% improvement in movement optimization I achieved demonstrated that algorithmic improvements can have dramatic real-world effects:

1. **Software meets hardware** - Seeing code translate into physical movement is deeply satisfying. It also teaches you to think about constraints (motor limits, physical obstacles, safety) that don't exist in pure software. A bug in a web app might cause a 500 error; a bug in robot control code might cause the robot to crash into something.

2. **Mathematical foundations matter** - The underlying mathematics of robotics—linear algebra, calculus, optimization—are not just academic exercises. Understanding them deeply enables you to innovate and improve algorithms. I gained a new appreciation for my math courses and saw how they apply directly to real engineering problems.

3. **Simulation accelerates development** - Building good simulation tools early pays dividends throughout a project. Being able to test safely and quickly is essential for robotics development. The CLI I built for visualizing arm movements saved countless hours and prevented potential damage to physical hardware.

4. **Real-world constraints** - Physical systems have latency, noise, and uncertainty that simulations don't capture. Learning to build robust systems that handle these realities is a crucial skill. Motors don't respond instantly, sensors have noise, and mechanical systems have tolerances that software needs to accommodate.

5. **Interdisciplinary work is rewarding** - This role combined software engineering, mathematics, physics, and mechanical design. Working across disciplines and seeing how they come together in a functioning robot was incredibly fulfilling.

---

<Tip>
  My first robotics experience and it was really rewarding to see my software working in the real world as opposed to strictly on a screen. It opened my eyes to the possibilities of software beyond traditional applications.
</Tip>
