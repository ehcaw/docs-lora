...
This internship was a pivotal experience that expanded my understanding of software's role in the physical world. It was my first robotics experience, and it was incredibly rewarding to see my software working in the real world as opposed to strictly on a screen.

1. **Software meets hardware** - Seeing code translate into physical movement is deeply satisfying in a way that purely digital software cannot replicate. It also teaches you to think about constraints (motor limits, physical obstacles, safety) that don't exist in pure software. Every algorithm has real-world consequences that you can observe immediately.

2. **Mathematical foundations matter** - The underlying mathematics of robotics—linear algebra, calculus, optimization—are not just academic exercises. Understanding them deeply enables you to innovate and improve algorithms. The gradient descent work I did required a solid grasp of multivariable calculus and numerical methods.

3. **Simulation accelerates development** - Building good simulation tools early pays dividends throughout a project. Being able to test safely and quickly is essential for robotics development, where mistakes can damage expensive hardware. The CLI I built for mocking arm movements saved countless hours of testing time.

4. **Real-world constraints** - Physical systems have latency, noise, and uncertainty that simulations don't capture. Learning to build robust systems that handle these realities is a crucial skill that has informed my approach to software reliability ever since.
