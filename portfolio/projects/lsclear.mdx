---
title: LSClear
description: A web-based Python IDE with file persistence across sessions, built with Monaco Editor, FastAPI, and NeonDB.
---
...
Maybe you're on a friend's computer, at a library, in a classroom, or just want a quick scratchpad to try out an idea. Online REPLs exist, but they often don't save your work (so you lose everything when you close the tab), have limited functionality, or require sign-ups and subscriptions. I wanted something that just works—open the URL, write code, run it, and come back later to find it exactly where I left it.
