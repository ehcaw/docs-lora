---
title: CatDoc
description: A CLI app that automatically generates and maintains documentation for your codebase using AI, built at HackDavis 2025 with Ink React and Gemini 2.5 Pro.
---
...
Documentation is always outdated. It's a universal truth of software development that transcends languages, frameworks, and team sizes. You write comprehensive docs when you start a project, carefully explaining architecture decisions and API contracts. But as the code evolves—new features added, bugs fixed, refactors completed—the docs lag behind. Before you know it, you're reading documentation that describes how the code worked six months ago, and new team members are learning the wrong things.

The issue isn't laziness—it's friction. Updating documentation is a manual process that competes with writing features and fixing bugs for developer attention. And it usually loses, because shipping features has immediate visible value while updating docs is invisible work that benefits the future. What if documentation could update itself?
